...
_JAVACLASSLOOKUPPAYLOAD.fields_by_name['constructor_schema'].message_type = schema__pb2._SCHEMA
_JAVACLASSLOOKUPPAYLOAD.fields_by_name['builder_methods'].message_type = _BUILDERMETHOD
_BUILDERMETHOD.fields_by_name['schema'].message_type = schema__pb2._SCHEMA
